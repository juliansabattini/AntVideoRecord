...
class Ui_ConfigurarPantalla(object):
    ...
    def preview_image(self):
        ...
        camera.capture('/home/pi/Desktop/AntVideoRecord/image.jpg')
        #camera.stop_preview()
        camera.close()
...
class Ui_MainWindow(QMainWindow):
    def setupUi(self, MainWindow):
       ...
       # self.horizontalLayout_2.addWidget(self.t_luz)
        ...
        self.actionAcerca_de_AntVideoRecord = QtWidgets.QAction(MainWindow)
        self.actionAcerca_de_AntVideoRecord.setObjectName("actionAcerca_de_AntVideoRecord")
        ...
        self.menuAyuda.addAction(self.actionAcerca_de_AntVideoRecord)
    ...
    def retranslateUi(self, MainWindow):
       ...
       # self.lb_luz.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:36pt;\">0</span></p></body></html>"))
        ...
        self.actionAcerca_de_AntVideroRecord.setText(_translate("MainWindow", "Acerca de AntVideoRecord"))
